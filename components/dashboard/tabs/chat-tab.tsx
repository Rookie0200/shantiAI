...
const chatMessages = [
  {
    id: 1,
    sender: "luna",
    message: "Hello John! I'm Luna, your AI wellness companion. How are you feeling today?",
    timestamp: "10:30 AM",
    type: "greeting",
  },
  {
    id: 2,
    sender: "user",
    message: "Hi Luna! I'm feeling a bit anxious about my presentation tomorrow.",
    timestamp: "10:32 AM",
    type: "concern",
  },
  {
  ...
  },
  {
    id: 4,
    sender: "user",
    message: "I'm worried I'll forget what to say or that people will judge me.",
    timestamp: "10:35 AM",
    type: "worry",
  },
  {
...
export function ChatTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Chat with Luna</h1>
          <p className="text-muted-foreground">Your AI wellness companion is here to support you</p>
        </div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-pink-500 text-white">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-purple-100 mb-4">
                Based on our conversation, I notice you're experiencing presentation anxiety. This is very common!
              </p>
              <Button className="w-full bg-white/20 hover:bg-white/30 border-white/30">View Suggestions</Button>
            </CardContent>
          </Card>
